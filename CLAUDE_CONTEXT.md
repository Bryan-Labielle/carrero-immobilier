...
- `documentation/CAHIER DES CHARGES CARRERO IMMOBILIER V1 AVRIL 2026.pdf` — Cahier des charges complet (21 pages)
- `documentation/ROADMAP-V1.md` — Features V1 + tâches ordonnées (9 phases, 70+ tâches)
- `documentation/DEVIS-CLIENT.md` — Devis client (48.5 jours, 12 000 € HT à 250 €/j)
- `documentation/ESTIMATION-INTERNE.md` — Estimation interne avec marges (55 jours, 13 750 € HT)
- `documentation/NOTES-TECHNIQUES.md` — Points d'attention sur les features critiques
- `.claude/plans/synthetic-purring-gadget.md` — Plan technique détaillé (architecture, schéma BDD, routes, services)
- `maquettes/` — Maquettes HTML (proposition-1 + proposition-2)
